...
extension RealTimeCameraViewController: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [UIImagePickerController.InfoKey : Any]) {
        ...
        if picker.isBeingDismissed == true {
            ...
            if FirebaseAuth.Auth.auth().currentUser != nil {
                ...
                KeyVariables.MyVaraibles.foundAnimalReal = animalDetected
                
                let animalToBeProcessedForURL = animalDetected.replacingOccurrences(of: " ", with: "_")
                
                KeyVariables.MyVaraibles.foundAnimalURLReal = animalToBeProcessedForURL
                ...
                if animalToBeProcessedForURL.isEmpty == false {
                    ...
                    StorageManager.storageManager.uploadAnImageTakenByUserReal(with: data, fileName: fileName, completion: {
                        result in
